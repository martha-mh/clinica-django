...
function layout_change(layout) {
  ...
  var logoSrc = isDark ? '../static/assets/images/logo-white.webp' : '../static/assets/images/logo-dark.jpg';
...
function layout_theme_sidebar_change(value) {
  if (value == 'true') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../static/assets/images/logo-dark.jpg');
    }
